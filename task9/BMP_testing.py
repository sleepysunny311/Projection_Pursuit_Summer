...
def run_trials_npm_multi_noise_lvl(n, p, m, noise_level_lst, model_name, fixed_params, param_grid, cv_num, trial_num):
    ...
    for noise_level in noise_level_lst:
        ...
        for trial_id in range(trial_num):
            ...
            best_estimator_coef_lst = best_estimator.coefficients_lst
            best_estimator_coef = best_estimator.coefficients
            ...
            reslog_one_trial = {'noise_level': noise_level, 'trial': trial_id, 'cv_error_lst': cv_err_lst, 
                            ...
                            'coef_lst': best_estimator_coef_lst, 'coef': best_estimator_coef}
        ...
        print("Noise level: ", noise_level, " Avg Lowest CV Error: ", np.mean(trials_loweset_cv_MSE_temp), ' Avg Training Score: ', np.mean(trails_training_score_temp), ' Avg Testing Score: ', np.mean(trials_testing_score_temp))
    return res_log_npm
