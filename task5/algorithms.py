...
class AtomBaggingOrthogonalMatchingPursuit(AtomBaggingBase):
    def __init__(self, K, atom_bag_percent=1, select_atom_percent=0, random_seed=None, ignore_warning=False):
        super().__init__(K, atom_bag_percent, select_atom_percent, random_seed, ignore_warning)
