...
def run_trials_npm_multi_noise_lvl(n, p, m, noise_level_lst, model_name, fixed_params, param_grid, cv_num, trial_num):
    ...
    for noise_level in noise_level_lst:
        ...
        print("Noise level: ", noise_level, " Avg Training Score: ", np.mean(trials_loweset_cv_MSE_temp), ' Avg Training Score: ', np.mean(trails_training_score_temp),
              ' Avg Testing Score: ', np.mean(trials_testing_score_temp))
    return res_log_npm
